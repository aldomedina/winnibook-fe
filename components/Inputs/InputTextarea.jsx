  ...
  return (
    <div className="mb-5 last:mb-0">
      ...
      <textarea
        ...
        id={id}
        className={`w-full bg-glass text-sm px-4 py-2 rounded focus:outline-none focus:ring-2 ring-current font-light h-36 lg:h-60 placeholder-current placeholder-opacity-50 ${
          error ? 'ring-2 ' : ''
        }`}
        value={value}
