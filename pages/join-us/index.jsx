  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex flex-col max-w-100vw md:w-70vw mx-auto p-4">
        ...
        <div className="flex-grow flex flex-wrap py-4 border-b">
          ...
          <div className="md:py-8 flex-grow flex flex-wrap">
            ...
            {/* 
              ...
              -
            */}
            <div className="px-4 mb-8 md:mb-0 md:w-1/2">
        ...
        <div className="flex-grow flex flex-wrap py-4">

          <h2 className="w-full px-4 mt-4 mb-8 text-xl font-bold">Contact</h2>

          <div className="md:px-4 mb-8 md:mb-0 flex-grow flex flex-wrap">
        ...
        <div className="w-full flex px-4 md:py-8 justify-end">

          <div className="w-full md:w-auto actions">
