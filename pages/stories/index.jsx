...
const Stories = () => {
  ...
  const [searchQuery, { data: storiesQueryResponse, loading, refetch }] = useLazyQuery(
    mountSearchQuery(!!filters.name, !!filters.mainCategory, !!filters.categories)
  );
  ...
  const searchStories = aFilters => {
    ...
    searchTimeout = setTimeout(() => {
      ...
      searchQuery({
        variables: {
          title: '%' + aFilters.name + '%',
          mainCategoryId: aFilters.mainCategory
            ? aFilters.mainCategory
            : '9349ae64-be69-11eb-8529-0242ac130003',
  ...
  return (
    <div className="h-full overflow-hidden">
      ...
      {!loading ? (
                ...
                <div className="w-full md:w-2/6">
                  <StoryCard
                    ...
                    categories={stories[0].categories
                      ...
                      .concat([stories[0]?.main_category])
                      .splice(0, 3)}
                    ...
                    <Link href={'/story/' + stories[index * i].id}>
                      <a>
                        <StoryCard
                          ...
                          categories={stories[index * i].categories
                            .map(cat => cat.category)
                            .concat([stories[index * i]?.main_category])
                            .splice(0, 3)}
                    ...
                    <Link href={'/story/' + stories[index * i + 1].id}>
                      <a>
                        <StoryCard
                          ...
                          categories={stories[index * i + 1].categories
                            .map(cat => cat.category)
                            .concat([stories[index * i + 1]?.main_category])
                            .splice(0, 3)}
                    ...
                    <Link href={'/story/' + stories[index * i + 2].id}>
                      <a>
                        <StoryCard
                          ...
                          categories={stories[index * i + 2].categories
                            .map(cat => cat.category)
                            .concat([stories[index * i + 2]?.main_category])
                            .splice(0, 3)}
                    ...
                    <Link href={'/story/' + stories[index * i + 3].id}>
                      <a>
                        <StoryCard
                          ...
                          categories={stories[index * i + 3].categories
                            .map(cat => cat.category)
                            .concat([stories[index * i + 3]?.main_category])
                            .splice(0, 3)}
                    ...
                    <Link href={'/story/' + stories[index * i + 4].id}>
                      <a>
                        <StoryCard
                          ...
                          categories={stories[index * i + 4].categories
                            .map(cat => cat.category)
                            .concat([stories[index * i + 4]?.main_category])
                            .splice(0, 3)}
                    ...
                    <Link href={'/story/' + stories[index * i + 5].id}>
                      <a>
                        <StoryCard
                          ...
                          categories={stories[index * i + 5].categories
                            .map(cat => cat.category)
                            .concat([stories[index * i + 5]?.main_category])
                            .splice(0, 3)}
                    ...
                    <Link href={'/story/' + stories[index * i + 6].id}>
                      <a>
                        <StoryCard
                          ...
                          categories={stories[index * i + 6].categories
                            .map(cat => cat.category)
                            .concat([stories[index * i + 6]?.main_category])
                            .splice(0, 3)}
                    ...
                    <Link href={'/story/' + stories[index * i + 7].id}>
                      <a>
                        <StoryCard
                          ...
                          categories={stories[index * i + 7].categories
                            .map(cat => cat.category)
                            .concat([stories[index * i + 7]?.main_category])
                            .splice(0, 3)}
        ...
        <div className="w-full min-h-100vh pb-20vh  flex justify-center items-center">
