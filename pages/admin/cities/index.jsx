...
import GET_ALL_CITIES from '../../../apollo/queries/admin/cities/allCities.gql';
            ...
            <tbody>
              {
                cities && cities.map((item) => (
                  <tr 
                    ...
                    onClick={() => router.push("/admin/city/" + item.id)}
                  >
...
export default withPageAuthRequired(Cities);
